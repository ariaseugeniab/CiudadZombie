...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_vertical.png', 80, 350, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 480, 420, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 800, 150, 30, 15, 1),
    new Obstaculo('imagenes/bache.png', 850, 250, 30, 30, 1),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 890, 230, 15, 15, 2, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie2.png', 400, 650, 15, 15, 2, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie3.png', 750, 150, 15, 15, 2, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie4.png', 610, 380, 15, 15, 2, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie3.png', 520, 490, 15, 15, 2, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    //conductores
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 5, {desdeX: 0, hastaX: 871, desdeY: 0, hastaY: 577},'h' ),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 150, 30, 90, 5, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 480},'v' ),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 5, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 480},'v' )
